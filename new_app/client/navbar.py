...
def Navbar(page):
    Navbar = ft.AppBar(
        ...
        actions=[
            ...
            ft.IconButton(
                ft.icons.PERSON_ROUNDED, on_click=lambda _: page.go("/private")
            ),
            ft.IconButton(
                ft.icons.ADD_BOX_ROUNDED, on_click=lambda _: page.go("/join-group")
            ),
            ft.IconButton(
                ft.icons.GROUP_ADD_ROUNDED, on_click=lambda _: page.go("/add-group")
            ),
